...
void test_add()
{
    Polynomial p1({{0, Rational(Integer(1), Natural(1))}, {1, Rational(Integer(2), Natural(1))}, {3, Rational(Integer(), Natural(1))}});
    ...
    Polynomial expected({{0, Rational(Integer(4), Natural(1))}, {1, Rational(Integer(3), Natural(1))}, {2, Rational(Integer(4), Natural(1))}});
...
void test_sub()
{
    ...
    Polynomial res = p1 - p2; 
    Polynomial expected({{0, Rational(Integer(2, 1), Natural(1))}, {1, Rational(Integer(2), Natural(1))}, {5, Rational(Integer(2,1), Natural(1))}});
    assert(res.toString() == expected.toString());
}
...
void test_led_deg()
{
    Polynomial p({{3, Rational(Integer(7), Natural(1))}});
...
void test_mod_pp_p()
{
    Polynomial p1({{0, Rational(Integer(1), Natural(1))}, {2, Rational(Integer(1), Natural(1))}});
    Polynomial p2({{1, Rational(Integer(1), Natural(1))}});
    Polynomial res = p1 % p2;

    Polynomial expected({{0, Rational(Integer(1), Natural(1))}});
    assert(res.toString() == expected.toString());
}
...
void test_nmr_p_p()
{
    ...
    Polynomial expected({
        {2, Rational(Integer(1), Natural(1))},
        {1, Rational(Integer(1, 1), Natural(1))},
        {0, Rational(Integer(2,1), Natural(1))}
    });
